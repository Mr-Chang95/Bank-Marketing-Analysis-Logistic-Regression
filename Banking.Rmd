...
>>>>>>> c283cbdcd072dea1a466235e47271076ac33dfec
...
plot_model(pen.model1, type = "pred", terms = c("duration","loan"))
plot_model(pen.model1, type = "pred", terms = c("duration","poutcome"))
plot_model(pen.model1, type = "pred", terms = c("duration","month"))
plot_model(pen.model1, type = "pred", terms = c("duration","housing"))
plot_model(pen.model1, type = "pred", terms = c("duration","marital"))
plot_model(pen.model1, type = "pred", terms = c("duration","job"))
plot_model(pen.model1, type = "pred", terms = c("duration","contact"))

plot_model(pen.model1, type = "pred", terms = c("previous","loan"))
plot_model(pen.model1, type = "pred", terms = c("previous","housing"))
plot_model(pen.model1, type = "pred", terms = c("previous","month"))
plot_model(pen.model1, type = "pred", terms = c("previous ","poutcome"))
plot_model(pen.model1, type = "pred", terms = c("previous","marital"))
plot_model(pen.model1, type = "pred", terms = c("previous","job"))
plot_model(pen.model1, type = "pred", terms = c("previous","contact"))

plot_model(pen.model1, type = "pred", terms = c("balance","loan"))
plot_model(pen.model1, type = "pred", terms = c("balance","housing"))
plot_model(pen.model1, type = "pred", terms = c("balance","month"))
plot_model(pen.model1, type = "pred", terms = c("balance ","poutcome"))
plot_model(pen.model1, type = "pred", terms = c("balance","marital"))
plot_model(pen.model1, type = "pred", terms = c("balance","job"))
plot_model(pen.model1, type = "pred", terms = c("balance","contact"))
```
