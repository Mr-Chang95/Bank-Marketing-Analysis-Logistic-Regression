...
```{r}
logit_complex = glm(factor(y) ~ poutcome +  poly(duration,2) + poutcome:poly(duration,2) + month + month:poly(duration,2) + contact + housing + housing:poly(duration,2) + job + campaign + campaign:poly(duration,2) + loan + loan:poly(duration,2) + marital + marital + education + day + balance + month:balance, 
